...
const Navbar = () => {
  ...
  return (
    <div className='sticky top-0 flex justify-between items-center h-24 max-w-[1240px] mx-auto px-10'>
      ...
      <ul className={nav ? 'fixed left-0 top-0 w-[60%] h-full border-r border-r-gray-900 backdrop-blur-xl ease-in-out duration-500' : 'ease-in-out duration-500 fixed left-[-100%]'}>
          <h2 className='font-mono w-full pt-10 font-extrabold text-transparent text-2xl bg-clip-text bg-gradient-to-r from-purple-400 to-blue-600 pl-8'>EstebanFranco.dev</h2>
